...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
   ...
   private String MY_SORT_PREF="setOrder";
    ...
    private void permission(){
        if(ContextCompat.checkSelfPermission(getApplicationContext(),
            ...
            ActivityCompat.requestPermissions(MainActivity.this,
                    new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},REQEST_CODE);
        }
        else {
    ...
    public   ArrayList<MusicFiles> getAllAudio(Context context)
    {
        ...
        if (cursor!=null)
        {
            while (cursor.moveToNext()) {
                ...
                MusicFiles musicFiles=new MusicFiles(path,title,artist,album,duration,_id);
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        SongListFragment.musicAdapter.updateList(myFiles);
        return false;
    }
    ...
    protected void onResume() {
        super.onResume();
        SharedPreferences preferences=getSharedPreferences(MUSIC_FILE_LAST,MODE_PRIVATE);
